(function () { 
    ...
    ModbusClient = function (con, sockets) { 
        ...
        this.con        = con;
        this.sockets    = sockets; // public sockets api
        ...
        this._receiveListener = function (data) { 
        ...
        this._sendPacket = function (packet) {
            ...
            this.sockets.send(this.con.socketId, packet, function () { });
