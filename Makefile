...
min: test $(SRC)/sugar.js $(SRC)/events.js $(SRC)/statemachine.js $(SRC)/modbus-client.js $(SRC)/modbus-loop.js $(SRC)/modbus-server.js $(SRC)/register.js
	uglifyjs $(SRC)/sugar.js $(SRC)/events.js $(SRC)/statemachine.js $(SRC)/modbus-client.js $(SRC)/modbus-loop.js $(SRC)/modbus-server.js $(SRC)/register.js -o $(BIN)/modbus.min.js -c drop_console=true --enclose 	
...
dev: $(SRC)/sugar.js $(SRC)/events.js $(SRC)/statemachine.js $(SRC)/modbus-client.js $(SRC)/modbus-loop.js $(SRC)/modbus-server.js $(SRC)/register.js
	uglifyjs $(SRC)/sugar.js $(SRC)/events.js $(SRC)/statemachine.js $(SRC)/modbus-client.js $(SRC)/modbus-loop.js $(SRC)/modbus-server.js $(SRC)/register.js -o $(BIN)/modbus.min.js --enclose
...
test: test-events test-statemachine test-client
